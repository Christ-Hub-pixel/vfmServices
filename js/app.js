...
const VFMApp = {
  ...
  initCarousels() {
    ...
    if (heroCarousel) {
      ...
      const slideCaptions = [
        {
          badge: '⚙️ Matériel Industriel & Équipements Certifiés',
          title: 'Fourniture & Équipements Industriels',
          sub: 'Matériels & composants industriels haute résistance pour le forage et le BTP.'
        },
        {
...
const VFMCart = {
  ...
  async generateQuotePDF(data = {}) {
    ...
    doc.setFont('helvetica', 'normal');
    doc.setFontSize(8);
    const splitNotes = doc.splitTextToSize(clientNotes || 'Aucune spécification particulière', 172);
